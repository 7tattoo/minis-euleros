package com.miniseuleros.app.speech
...
import com.miniseuleros.app.provider.voice.VoiceInputRequest
import com.miniseuleros.app.provider.voice.VoiceProvider
import com.miniseuleros.app.provider.voice.VoiceProviderException
import com.miniseuleros.app.provider.voice.VoiceProviderFactory
...
class ProviderSpeechRecognitionEngine(private val appContext: Context) : SpeechRecognitionEngine {
    ...
    private fun startVadCapture(
        locale: Locale,
        repo: com.miniseuleros.app.data.repository.ProviderRepository,
        candidates: List<Pair<com.miniseuleros.app.data.model.ProviderInstance, com.miniseuleros.app.data.model.ModelEntry>>,
