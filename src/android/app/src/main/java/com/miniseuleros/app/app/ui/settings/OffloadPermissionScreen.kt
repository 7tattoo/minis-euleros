...
fun OffloadPermissionScreen(
    ...
    val configEnabled by com.miniseuleros.app.config.MinisConfigPermissionStore.enabled.collectAsState()
    ...
    SettingsScaffold(
        ...
        SettingsSection(
            ...
            SettingsSwitchRow(
                ...
                onCheckedChange = {
                    com.miniseuleros.app.config.MinisConfigPermissionStore.setEnabled(it)
                },
                showDivider = false,
            )
        }
        ...
        AlertDialog(
            ...
            confirmButton = {
                MinisTextButton(onClick = {
                    ...
                    com.miniseuleros.app.config.MinisConfigPermissionStore.setEnabled(true)
