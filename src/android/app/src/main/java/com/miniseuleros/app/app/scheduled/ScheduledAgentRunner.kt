package com.miniseuleros.app.scheduled
...
import com.miniseuleros.app.debug.HeadlessChatRunner
import com.miniseuleros.app.logging.AppLogger
import com.miniseuleros.app.service.AgentForegroundService
    ...
    private suspend fun resolveSessionId(app: MinisApp, task: ScheduledTask): String? {
        return when (val mode = task.targetMode) {
            ...
            ScheduledTargetMode.NewSession -> {
                ...
                val memoryOn = com.miniseuleros.app.data.MemoryGlobalPrefs.isGlobalEnabled(app)
