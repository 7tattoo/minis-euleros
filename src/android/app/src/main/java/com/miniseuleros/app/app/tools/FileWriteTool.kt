...
object FileWriteTool {
    ...
    fun execute(argsJson: String, sessionId: String, context: Context): ToolExecutionResult {
        return try {
            ...
            // T123: per-session resolver so /var/minis-euleros/workspace/...,
            // /var/minis-euleros/attachments/..., /var/minis-euleros/offloads/...,
            // /var/minis-euleros/browser/... land in this session's host dir
            ...
            // /var/minis-euleros/workspace/foo/bar.md would otherwise hit "Parent
            ...
            if (path.startsWith("/var/minis-euleros/mounts/")) {
