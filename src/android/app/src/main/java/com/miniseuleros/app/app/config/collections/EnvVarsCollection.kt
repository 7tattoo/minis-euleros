package com.miniseuleros.app.config.collections

import com.miniseuleros.app.config.ConfigCollection
import com.miniseuleros.app.config.ConfigError
import com.miniseuleros.app.config.ConfigField
import com.miniseuleros.app.config.ConfigRisk
import com.miniseuleros.app.config.ConfigSchema
import com.miniseuleros.app.config.ConfigValue
import com.miniseuleros.app.config.fields.ClosureField
import com.miniseuleros.app.config.fields.HiddenField
 ...
 * `miniseuleros://settings/environments?create_key=…` so the user supplies
 * the value directly.
 */
class EnvVarsCollection(
    ...
    override fun add(payload: ConfigValue): String {
        throw ConfigError.PermissionDenied(
            "Use the deep link `miniseuleros://settings/environments?create_key=…` so the user enters the value directly"
        )
    }
