 ...
 *     also accepts a Linux file path under /var/minis-euleros/... resolved via
...
class SpeechOffloadHandler(private val context: Context) : NativeOffloadHandler {
    ...
    private fun cmdTranscribe(args: OffloadArgs): NativeOffloadResult {
        ...
        // --source: default mic, accept "mic" / "system-mic" / any /var/minis-euleros/... path.
    ...
    /**
     * Resolve a `/var/minis-euleros/...`-style Linux path to a host File via
...
EXAMPLES:
  ...
  android-speech transcribe --source /var/minis-euleros/attachments/meeting.m4a
  android-speech languages
