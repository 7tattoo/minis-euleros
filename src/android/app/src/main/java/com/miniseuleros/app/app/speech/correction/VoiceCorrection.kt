package com.miniseuleros.app.speech.correction

import android.content.Context
import android.util.Log
import com.miniseuleros.app.MinisApp
import com.miniseuleros.app.shared.TextSegmenter
...
object VoiceCorrection {
    ...
    fun ensureInitialized(context: Context) {
        ...
        val dao = runCatching {
            com.miniseuleros.app.data.db.AppDatabase.getInstance(app).chatDao()
        }.getOrNull()
        if (dao != null) {
    ...
    fun buildConversationContext(
        context: Context,
        messages: List<com.miniseuleros.app.ui.chat.ChatMessage>,
    ): ConversationContext {
        ensureInitialized(context)
