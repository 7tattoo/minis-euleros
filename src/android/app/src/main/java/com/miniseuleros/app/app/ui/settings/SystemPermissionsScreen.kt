...
import com.miniseuleros.app.accessibility.MinisAccessibilityService
import com.miniseuleros.app.accessibility.RestrictedSettingsManager
import com.miniseuleros.app.offload.ShizukuManager
import com.miniseuleros.app.power.PowerOptimizationManager
    ...
    Scaffold(
        ...
        Column(
            ...
            var correctionEnabled by remember {
                mutableStateOf(
                    com.miniseuleros.app.speech.correction.VoiceCorrectionConsent.isEnabled(context),
                )
            }
