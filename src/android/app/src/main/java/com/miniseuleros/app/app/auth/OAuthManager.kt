package com.miniseuleros.app.auth
...
abstract class OAuthManager(
    ...
    companion object {
        ...
        fun hasStoredCredential(context: Context, instanceId: String): Boolean {
            val prefs = com.miniseuleros.app.util.EncryptedPrefsFactory
        ...
        fun forInstance(context: Context, instance: com.miniseuleros.app.data.model.ProviderInstance): OAuthManager? {
            return when (instance.providerType) {
                com.miniseuleros.app.data.model.ProviderType.anthropic -> ClaudeOAuthManager(context, instance.id)
                com.miniseuleros.app.data.model.ProviderType.openAI -> OpenAIOAuthManager(context, instance.id)
                com.miniseuleros.app.data.model.ProviderType.xAI -> XAIOAuthManager(context, instance.id)
                com.miniseuleros.app.data.model.ProviderType.kimiCode -> KimiOAuthManager(context, instance.id)
                else -> null
            }
        }
    }
    ...
    private fun getEncryptedPrefs() =
        com.miniseuleros.app.util.EncryptedPrefsFactory.safeCreate(context, "oauth_prefs")
