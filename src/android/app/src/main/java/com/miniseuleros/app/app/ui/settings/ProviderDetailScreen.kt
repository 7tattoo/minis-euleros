package com.miniseuleros.app.ui.settings
...
import com.miniseuleros.app.ui.util.bringIntoViewOnFocus
import com.miniseuleros.app.R
import kotlinx.coroutines.launch
import com.miniseuleros.app.ui.components.MinisButton
import com.miniseuleros.app.ui.components.MinisOutlinedButton
import com.miniseuleros.app.ui.components.MinisSmallButton
import com.miniseuleros.app.ui.components.MinisSmallOutlinedButton
import com.miniseuleros.app.ui.components.MinisSmallTextButton
import com.miniseuleros.app.ui.components.MinisTextButton
import com.miniseuleros.app.ui.components.SectionTextField
...
fun ProviderDetailScreen(
    ...
    var entryToDelete by remember { mutableStateOf<com.miniseuleros.app.data.model.ModelEntry?>(null) }
    ...
    SettingsScaffold(
        ...
        if (instance.supportsImageEndpointSetting) {
            ...
            SettingsSection(
                ...
                footer = when (mode) {
                    com.miniseuleros.app.data.model.ImageEndpointMode.auto ->
                        if (instance.imageEndpointResolved != null) {
                            val resolved = if (instance.imageEndpointResolved ==
                                com.miniseuleros.app.data.model.ImageEndpointMode.imagesGenerations
                    ...
                    com.miniseuleros.app.data.model.ImageEndpointMode.chatCompletions ->
                ...
                SettingsCardBlock {
                    SingleChoiceSegmentedButtonRow(modifier = Modifier.fillMaxWidth()) {
                        SegmentedButton(
                            selected = mode == com.miniseuleros.app.data.model.ImageEndpointMode.auto,
                            onClick = {
                                if (mode != com.miniseuleros.app.data.model.ImageEndpointMode.auto) {
                                    providerRepository.updateInstance(
                                        instance.copy(
                                            imageEndpointMode = com.miniseuleros.app.data.model.ImageEndpointMode.auto,
                                        ),
                                    )
                                }
                            },
                        ...
                        SegmentedButton(
                            selected = mode == com.miniseuleros.app.data.model.ImageEndpointMode.imagesGenerations,
                            onClick = {
                                if (mode != com.miniseuleros.app.data.model.ImageEndpointMode.imagesGenerations) {
                                    providerRepository.updateInstance(
                                        instance.copy(
                                            imageEndpointMode = com.miniseuleros.app.data.model.ImageEndpointMode.imagesGenerations,
                        ...
                        SegmentedButton(
                            selected = mode == com.miniseuleros.app.data.model.ImageEndpointMode.chatCompletions,
                            onClick = {
                                if (mode != com.miniseuleros.app.data.model.ImageEndpointMode.chatCompletions) {
                                    providerRepository.updateInstance(
                                        instance.copy(
                                            imageEndpointMode = com.miniseuleros.app.data.model.ImageEndpointMode.chatCompletions,
                                            imageEndpointResolved = null,
                                        ),
                                    )
                                }
...
private fun OAuthCredentialBlock(
    instance: com.miniseuleros.app.data.model.ProviderInstance,
    storedKey: String,
    providerRepository: ProviderRepository,
) {
    ...
    var kimiDeviceAuth by remember(instance.id) {
        mutableStateOf<com.miniseuleros.app.auth.KimiDeviceFlow.DeviceAuthorization?>(null)
    }
    ...
    if (displayedKey.isNotEmpty()) {
        MinisSmallButton(
            onClick = {
                ...
                com.miniseuleros.app.auth.OAuthManager.forInstance(context, instance)?.logout()
                    ...
                    try {
                        val token = when (instance.providerType) {
                            ProviderType.kimiCode ->
                                com.miniseuleros.app.auth.KimiOAuthManager.login(
                                    context, instance.id, providerRepository,
                                    onDeviceCode = { auth -> kimiDeviceAuth = auth },
                                ).also { kimiDeviceAuth = null }
                            ProviderType.anthropic ->
                                com.miniseuleros.app.auth.ClaudeOAuthManager.login(
                                    context, instance.id, providerRepository,
                                )
                            ProviderType.openAI ->
                                com.miniseuleros.app.auth.OpenAIOAuthManager.login(
                                    context, instance.id, providerRepository,
                                )
                            ProviderType.openRouter ->
                                com.miniseuleros.app.auth.OpenRouterOAuthManager.login(
                                    context, instance.id, providerRepository,
                                )
                            ProviderType.xAI ->
                                com.miniseuleros.app.auth.XAIOAuthManager.login(
                                    context, instance.id, providerRepository,
                                )
                            else -> null
                        }
...
private fun ManualBearerTokenSection(
    ...
    val manager = remember(instance.id) {
        com.miniseuleros.app.auth.OAuthManager.forInstance(context, instance)
    }
