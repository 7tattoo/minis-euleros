...
/**
 * One configurable setting. Concrete kinds: [com.miniseuleros.app.config.fields.PrefsBoolField]
 * etc. for SharedPreferences-backed scalars; [com.miniseuleros.app.config.fields.ClosureField]
