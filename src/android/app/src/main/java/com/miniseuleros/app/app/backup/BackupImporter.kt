package com.miniseuleros.app.backup
...
class BackupImporter(
    ...
    private val app: com.miniseuleros.app.MinisApp?
        get() = context.applicationContext as? com.miniseuleros.app.MinisApp
    ...
    companion object {
        ...
        internal data class LenientProviderConfig(
            val config: com.miniseuleros.app.data.model.ProviderConfig,
        ...
        internal fun parseProviderConfigLeniently(text: String): LenientProviderConfig {
            ...
            if (rawInstances == null) {
                return LenientProviderConfig(
                    BackupFormat.json.decodeFromJsonElement(
                        com.miniseuleros.app.data.model.ProviderConfig.serializer(), root,
                    ),
                    droppedInstances = 0,
                )
            }

            val knownTypes = com.miniseuleros.app.data.model.ProviderType.entries.map { it.name }.toSet()
            ...
            for (element in rawInstances) {
                ...
                val normalized = if (rawType != null && rawType !in knownTypes) {
                    ...
                    JsonObject(
                        obj + ("providerType" to kotlinx.serialization.json.JsonPrimitive(
                            com.miniseuleros.app.data.model.ProviderType.unsupported.name,
                        )),
                    )
                } else obj
                ...
                val decodes = runCatching {
                    BackupFormat.json.decodeFromJsonElement(
                        com.miniseuleros.app.data.model.ProviderInstance.serializer(), normalized,
                    )
                }
            ...
            return LenientProviderConfig(
                BackupFormat.json.decodeFromJsonElement(
                    com.miniseuleros.app.data.model.ProviderConfig.serializer(), patched,
                ),
