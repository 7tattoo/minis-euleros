...
import com.miniseuleros.app.data.db.AppDatabase
import com.miniseuleros.app.data.db.DatabaseVersionGuard
import com.miniseuleros.app.data.repository.BackgroundSettingsRepository
import com.miniseuleros.app.data.repository.ChatRepository
import com.miniseuleros.app.data.repository.EnvVarRepository
import com.miniseuleros.app.data.MountedFoldersStore
...
import com.miniseuleros.app.data.repository.WebAppShortcutRepository
import com.miniseuleros.app.data.repository.MCPRepository
import com.miniseuleros.app.data.repository.SkillRepository
import com.miniseuleros.app.notification.BackgroundTaskNotifier
import com.miniseuleros.app.logging.AppLogger
import com.miniseuleros.app.network.NetworkMonitor
import com.miniseuleros.app.offload.OffloadPermissionManager
import com.miniseuleros.app.provider.ModelsDevApi
import com.miniseuleros.app.sandbox.ExecutionCoordinator
import com.miniseuleros.app.sandbox.MountedFolderCoordinator
import com.miniseuleros.app.sandbox.NativeOffloadServer
import com.miniseuleros.app.sandbox.PRootKernel
import com.miniseuleros.app.sandbox.RootfsManager
import com.miniseuleros.app.sandbox.offload.AccessibilityOffloadHandler
import com.miniseuleros.app.sandbox.offload.AlarmOffloadHandler
import com.miniseuleros.app.sandbox.offload.BrowserUseOffloadHandler
import com.miniseuleros.app.sandbox.offload.CalendarOffloadHandler
import com.miniseuleros.app.sandbox.offload.ClipboardOffloadHandler
import com.miniseuleros.app.sandbox.offload.ContactsOffloadHandler
import com.miniseuleros.app.sandbox.offload.DeviceOffloadHandler
import com.miniseuleros.app.sandbox.offload.LocationOffloadHandler
import com.miniseuleros.app.sandbox.offload.ModelUseOffloadHandler
import com.miniseuleros.app.sandbox.offload.SessionsOffloadHandler
import com.miniseuleros.app.sandbox.offload.ShizukuOffloadHandler
import com.miniseuleros.app.sandbox.offload.NotificationOffloadHandler
import com.miniseuleros.app.sandbox.offload.OpenOffloadHandler
import com.miniseuleros.app.sandbox.offload.PhotosOffloadHandler
import com.miniseuleros.app.sandbox.offload.PlayerOffloadHandler
import com.miniseuleros.app.sandbox.offload.SpeakOffloadHandler
import com.miniseuleros.app.sandbox.offload.SpeechOffloadHandler
import com.miniseuleros.app.sandbox.offload.WeatherOffloadHandler
import com.miniseuleros.app.service.SessionActivityTracker
import com.miniseuleros.app.ui.MinisImageFetcher
...
class MinisApp : Application(), ImageLoaderFactory {
    ...
    override fun onCreate() {
        ...
        com.miniseuleros.app.data.FastModePrefs.prime(this)
        ...
        // Activity context.
        com.miniseuleros.app.data.AutoCompactPrefs.prime(this)
        ...
        // libs first execute.
        try {
            com.miniseuleros.app.crash.NativeCrashHandler.install(
            ...
            Thread.setDefaultUncaughtExceptionHandler { thread, throwable ->
                try {
                    ...
                    if (isFgsTimeout) {
                        ...
                        runCatching {
                            val intent = Intent(this, com.miniseuleros.app.service.AgentForegroundService::class.java)
                            stopService(intent)
                        }
                    }
                } catch (t: Throwable) {
        ...
        com.miniseuleros.app.crash.CrashFrequencyDetector.checkAtLaunch(this)
        ...
        // [com.miniseuleros.app.diagnostics.LaunchCycleBeacon].
        try {
            com.miniseuleros.app.diagnostics.LaunchCycleBeacon.recordLaunch(this)
        } catch (t: Throwable) {
        ...
        com.miniseuleros.app.diagnostics.HangDetector.start(this)
        ...
        com.miniseuleros.app.agent.SoulStore.ensureExists(this)
        com.miniseuleros.app.agent.SoulStore.refreshCache(this)
        ...
        com.miniseuleros.app.config.MinisConfigPermissionStore.init(this)
        com.miniseuleros.app.config.audit.ConfigAuditLog.init(this)
        com.miniseuleros.app.config.ConfigRegistry.init(
        ...
        com.miniseuleros.app.data.EnvVarPrivacyStore.init(this)
        com.miniseuleros.app.data.EnvVarRedactor.envVarRepository = envVarRepository
        ...
        NativeOffloadServer.register(
            "minis-config",
            com.miniseuleros.app.sandbox.offload.ConfigOffloadHandler(),
        )
        ...
        NativeOffloadServer.register(
            "minis-scheduled",
            com.miniseuleros.app.sandbox.offload.ScheduledTaskOffloadHandler(this),
        )
        ...
        com.miniseuleros.app.offload.ShizukuManager.init(this)
        ...
        if (BuildConfig.DEBUG) {
            NativeOffloadServer.register(
                "minis-debug",
                com.miniseuleros.app.sandbox.offload.DebugOffloadHandler(this),
            )
        }
        ...
        com.miniseuleros.app.service.SessionBadgeStore.init(this)
        ...
        kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.IO).launch {
            ...
            com.miniseuleros.app.service.SessionBadgeStore.reconcileInterruptedSessions(interrupted - active)
        }
        ...
        val configConfirmNotifier = com.miniseuleros.app.notification.ConfigConfirmNotifier(
            context = this,
            backgroundSettings = backgroundSettingsRepository,
            isAppForeground = ::isAppForeground,
        )
        com.miniseuleros.app.config.confirm.ConfigConfirmationGate.backgroundNotifier = {
            configConfirmNotifier.notifyIfBackgrounded(it)
        }
        com.miniseuleros.app.config.confirm.ConfigConfirmationGate.cancelNotification = {
        ...
        registerActivityLifecycleCallbacks(object : ActivityLifecycleCallbacks {
            ...
            override fun onActivityResumed(activity: Activity) {
                ...
                com.miniseuleros.app.crash.CrashFrequencyDetector.maybeShowOnActivity(activity)
            ...
            override fun onActivityStopped(activity: Activity) {
                ...
                if (foregroundActivityCount == 0) {
                    ...
                    com.miniseuleros.app.config.confirm.ConfigConfirmationGate.notifyPending()
                }
            }
        ...
        com.miniseuleros.app.speech.SpeechRecognitionManager.init(this)
        ...
        if (BuildConfig.DEBUG) {
            try {
                com.miniseuleros.app.debug.DebugServer(this).start()
            } catch (e: Exception) {
    ...
    override fun onTrimMemory(level: Int) {
        ...
        runCatching { com.miniseuleros.app.ui.chat.KatexWebViewPool.evictAll() }
            .onFailure { Log.w("MinisApp", "KatexWebViewPool.evictAll failed: ${it.message}") }
        runCatching { com.miniseuleros.app.ui.markdown.KaTeXRendererCache.evictAll() }
        ...
        if (level >= TRIM_MEMORY_COMPLETE) {
            ...
            runCatching { com.miniseuleros.app.ui.chat.KatexWebViewPool.releaseWebView() }
    ...
    override fun onTerminate() {
        ...
        try {
            com.miniseuleros.app.diagnostics.LaunchCycleBeacon.recordCleanExit(this)
        } catch (t: Throwable) {
