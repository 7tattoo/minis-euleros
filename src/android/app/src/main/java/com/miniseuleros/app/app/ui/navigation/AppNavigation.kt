package com.miniseuleros.app.ui.navigation
...
import com.miniseuleros.app.deeplink.DeepLinkAction
import com.miniseuleros.app.deeplink.DeepLinkCoordinator
import com.miniseuleros.app.ui.settings.KEY_LAUNCH_SESSION
import com.miniseuleros.app.ui.settings.getAppearancePrefs
...
import com.miniseuleros.app.ui.chat.ChatScreen
import com.miniseuleros.app.ui.sessions.SessionListScreen
import com.miniseuleros.app.ui.settings.AboutScreen
import com.miniseuleros.app.ui.settings.AddAgentLoopGroupsScreen
import com.miniseuleros.app.ui.settings.AddAgentLoopModelsScreen
import com.miniseuleros.app.ui.settings.AddCustomModelScreen
import com.miniseuleros.app.ui.settings.BackgroundSettingsScreen
import com.miniseuleros.app.ui.settings.AddModelsToGroupScreen
import com.miniseuleros.app.ui.settings.ShadowVoiceDetailScreen
import com.miniseuleros.app.ui.settings.AddProviderScreen
import com.miniseuleros.app.ui.settings.ModelEntryDetailScreen
import com.miniseuleros.app.ui.settings.ModelGroupDetailScreen
import com.miniseuleros.app.ui.settings.ModelGroupsScreen
import com.miniseuleros.app.ui.settings.ProviderDetailScreen
import com.miniseuleros.app.ui.settings.ProviderListScreen
import com.miniseuleros.app.ui.sandbox.FileBrowserScreen
import com.miniseuleros.app.ui.sandbox.FileBrowserViewModel
import com.miniseuleros.app.ui.sandbox.FileItem
import com.miniseuleros.app.ui.sandbox.FilePreviewScreen
import com.miniseuleros.app.ui.sandbox.RootfsManagementScreen
import com.miniseuleros.app.ui.settings.EnvironmentVariablesScreen
import com.miniseuleros.app.ui.settings.AppearanceScreen
import com.miniseuleros.app.ui.settings.SettingsScreen
import com.miniseuleros.app.ui.settings.SystemPermissionsScreen
import com.miniseuleros.app.ui.settings.SessionStorageDetailScreen
import com.miniseuleros.app.ui.settings.SkillDetailScreen
import com.miniseuleros.app.ui.settings.StorageManagementScreen
import com.miniseuleros.app.ui.settings.SkillFileViewerScreen
import com.miniseuleros.app.ui.settings.UsageStatsScreen
import com.miniseuleros.app.ui.settings.MinisSkillsBrowserScreen
import com.miniseuleros.app.ui.settings.MountDetailScreen
import com.miniseuleros.app.ui.settings.MountedFoldersScreen
import com.miniseuleros.app.ui.settings.SharedFolderDetailScreen
import com.miniseuleros.app.ui.settings.SharedFoldersScreen
import com.miniseuleros.app.ui.settings.SkillsManagementScreen
import com.miniseuleros.app.data.repository.EnvVarRepository
import com.miniseuleros.app.data.repository.MemoryRepository
import com.miniseuleros.app.data.repository.SkillRepository
import com.miniseuleros.app.ui.settings.LogDetailScreen
import com.miniseuleros.app.ui.settings.LogManagementScreen
import com.miniseuleros.app.ui.settings.MemoryFileEditScreen
import com.miniseuleros.app.ui.settings.MemoryManagementScreen
import com.miniseuleros.app.ui.settings.OffloadPermissionScreen
import com.miniseuleros.app.ui.settings.ShizukuPermissionScreen
import com.miniseuleros.app.sandbox.RootfsManager
import com.miniseuleros.app.sandbox.TerminalSession
import com.miniseuleros.app.ui.terminal.TerminalScreen
import com.miniseuleros.app.ui.onboarding.OnboardingModelSelectionScreen
...
fun AppNavigation(
    ...
    val mountedFoldersStore = remember {
        (context.applicationContext as com.miniseuleros.app.MinisApp).mountedFoldersStore
    }
    ...
    LaunchedEffect(Unit) {
        ...
        val hasPendingShare =
            com.miniseuleros.app.share.ShareCoordinator.bufferVersion.value > 0
        ...
        val mode = if (
            com.miniseuleros.app.diagnostics.HangDetector.shouldForceHomeOnLaunch(context) ||
            com.miniseuleros.app.crash.CrashFrequencyDetector.shouldForceHomeOnLaunch(context) ||
            com.miniseuleros.app.diagnostics.LaunchCycleBeacon.shouldForceHomeOnLaunch()
        ) 3 else rawMode
    ...
    NavHost(
        ...
        composable(Routes.BACKUP) {
            com.miniseuleros.app.ui.settings.backup.BackupAndRestoreScreen(
                onBack = { navController.safePopBackStack() },
        ...
        composable(
            ...
            val history = remember { com.miniseuleros.app.backup.BackupHistory.get(ctx) }
            ...
            if (record == null) {
                ...
                // the screen.
                val vm: com.miniseuleros.app.ui.settings.backup.BackupViewModel =
                    androidx.lifecycle.viewmodel.compose.viewModel()
                com.miniseuleros.app.ui.settings.backup.BackupHistoryDetailScreen(
                    record = record,
                    onBack = { navController.safePopBackStack() },
                    onRemove = {
                        history.remove(id)
        ...
        composable(
            ...
            val remote = remember(name) {
                com.miniseuleros.app.backup.remote.RcloneRemoteStore(ctx).remote(name)
            }
            if (remote == null) {
                ...
                val vm: com.miniseuleros.app.ui.settings.backup.BackupViewModel =
                    androidx.lifecycle.viewmodel.compose.viewModel()
                com.miniseuleros.app.ui.settings.backup.BackupDestinationBrowseScreen(
                    remote = remote,
                    vm = vm,
                    onBack = { navController.safePopBackStack() },
                )
        ...
        composable(Routes.RESTORE_SERVERS) {
            com.miniseuleros.app.ui.settings.backup.RestoreServersScreen(
                onBack = { navController.safePopBackStack() },
                onPickServer = { name ->
                    navController.safeNavigate(
                        "${Routes.RESTORE_BROWSE}/" + android.net.Uri.encode(name),
        ...
        composable(
            ...
            if (remote == null) {
                ...
                com.miniseuleros.app.ui.settings.backup.RestoreBrowseScreen(
                    remote = remote,
                    vm = vm,
                    onBack = { navController.safePopBackStack() },
        ...
        composable(Routes.BACKUP_DESTINATIONS) {
            com.miniseuleros.app.ui.settings.backup.RcloneDestinationsScreen(
                onBack = { navController.safePopBackStack() },
            )
        }
            ...
            SharedFolderDetailScreen(
                ...
                onBrowseFiles = {
                    ...
                    val label = when (folderId) {
                        ...
                        "memory" -> ctx.getString(com.miniseuleros.app.R.string.shared_folder_name_memory)
                        else -> folderId
                    }
        ...
        composable(
            ...
            val category = com.miniseuleros.app.ui.sandbox.MirrorCatalog.categoryFromKey(categoryKey)
                ?: return@composable
            com.miniseuleros.app.ui.sandbox.MirrorCategoryDetailScreen(
                category = category,
                onBack = { navController.safePopBackStack() },
            )
        }
        ...
        composable(
            ...
            val vm = remember(rootfs.rootfsDir.absolutePath, varMinis.absolutePath, sessionId) {
                FileBrowserViewModel(
                    ...
                    // inside EulerOS's var/minis/ — every subdir reads as
        ...
        composable(Routes.MCP) {
            if (mcpRepository != null) {
                com.miniseuleros.app.ui.settings.MCPIntegrationsScreen(
                    mcpRepository = mcpRepository,
                    onBack = { navController.safePopBackStack() },
                    envVarRepository = envVarRepository,
                )
        ...
        composable(Routes.SOUL) {
            com.miniseuleros.app.ui.settings.SoulSettingsScreen(
                onBack = { navController.safePopBackStack() },
            )
        }
        ...
        composable(Routes.SCHEDULED_TASKS) {
            com.miniseuleros.app.ui.scheduled.ScheduledTasksScreen(
                onBack = { navController.safePopBackStack() },
                onEditTask = { taskId ->
        ...
        composable(
            ...
            com.miniseuleros.app.ui.scheduled.ScheduledTaskRunsScreen(
                taskId = taskId,
                onBack = { navController.safePopBackStack() },
                onOpenSession = { sessionId ->
                    navController.safeNavigate(Routes.chat(sessionId))
        ...
        composable(
            ...
            com.miniseuleros.app.ui.scheduled.ScheduledTaskEditScreen(
                taskId = taskId,
                onBack = { navController.safePopBackStack() },
                onOpenSession = { sessionId ->
                    navController.safeNavigate(Routes.chat(sessionId))
