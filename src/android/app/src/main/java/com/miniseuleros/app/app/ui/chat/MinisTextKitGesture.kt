    ...
    Popup(
        ...
        Surface(
            ...
            Row(
                ...
                val labelCopy = androidx.compose.ui.res.stringResource(com.miniseuleros.app.R.string.selection_copy)
                val labelAddToInput = androidx.compose.ui.res.stringResource(com.miniseuleros.app.R.string.selection_add_to_chat_input)
                val labelCopyFullText = androidx.compose.ui.res.stringResource(com.miniseuleros.app.R.string.selection_copy_full_text)
                val labelCopyAsMarkdown = androidx.compose.ui.res.stringResource(com.miniseuleros.app.R.string.selection_copy_as_markdown)
                val labelCopyAsRichText = androidx.compose.ui.res.stringResource(com.miniseuleros.app.R.string.selection_copy_as_rich_text)
                val labelCopyAsPlainText = androidx.compose.ui.res.stringResource(com.miniseuleros.app.R.string.selection_copy_as_plain_text)
                val toastCopiedAsPlainText = androidx.compose.ui.res.stringResource(com.miniseuleros.app.R.string.selection_copied_as_plain_text_toast)
                ...
                val labelReadSelection = androidx.compose.ui.res.stringResource(com.miniseuleros.app.R.string.selection_read_aloud)
                val labelReadFromStart = androidx.compose.ui.res.stringResource(com.miniseuleros.app.R.string.selection_read_from_start)
                val labelReadAloud = androidx.compose.ui.res.stringResource(com.miniseuleros.app.R.string.read_aloud_group)
                val toastCopiedAsMarkdown = androidx.compose.ui.res.stringResource(com.miniseuleros.app.R.string.selection_copied_as_markdown_toast)
                val toastCopiedAsRichText = androidx.compose.ui.res.stringResource(com.miniseuleros.app.R.string.selection_copied_as_rich_text_toast)
                ...
                val labelCopyTable = androidx.compose.ui.res.stringResource(
                    com.miniseuleros.app.R.string.markdown_table_copy_table)
                val labelCopyTableImage = androidx.compose.ui.res.stringResource(
                    com.miniseuleros.app.R.string.markdown_table_copy_table_image)
                    ...
                    add(SelectionAction(labelCopy) {
                        ...
                        if (text.isNotEmpty()) {
                            ...
                            toast(context.getString(
                                com.miniseuleros.app.R.string.selection_copied_toast, preview(text)))
                        }
                        controller.clearSelection()
                    })
