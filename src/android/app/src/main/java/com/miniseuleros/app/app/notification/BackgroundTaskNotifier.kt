package com.miniseuleros.app.notification
 ...
 *
 * Trigger contract: this class is hooked into [com.miniseuleros.app.service.SessionActivityTracker]
 ...
 *   `miniseuleros://session/<sessionId>` (existing
...
class BackgroundTaskNotifier(
    ...
    /**
     * Called by [com.miniseuleros.app.service.SessionActivityTracker] when a
    ...
    private fun postNotification(sessionId: String, title: String, body: String) {
        ...
        val deepLink = Uri.parse("miniseuleros://session/$sessionId")
