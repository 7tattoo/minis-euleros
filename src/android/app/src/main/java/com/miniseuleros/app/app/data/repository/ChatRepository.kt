...
import com.miniseuleros.app.data.db.ChatDao
...
import com.miniseuleros.app.data.model.ModelAttributionSnapshot
...
class ChatRepository(internal val dao: ChatDao) {
     ...
     * from [com.miniseuleros.app.data.model.ContentPart]: "toolUse" / "toolResult"
     ...
     * [com.miniseuleros.app.ui.chat.ChatViewModel.rerunFromToolBlock]'s block-
    ...
    /**
     * Paginated raw [MessageEntity] page — used by [com.miniseuleros.app.share.ChatExporter]
