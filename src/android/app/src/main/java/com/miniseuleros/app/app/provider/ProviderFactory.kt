package com.miniseuleros.app.provider
...
import com.miniseuleros.app.provider.anthropic.AnthropicProvider
import com.miniseuleros.app.provider.gemini.GeminiProvider
import com.miniseuleros.app.provider.openai.OpenAIProvider
        ...
        val provider: LLMProvider = when (instance.providerType) {
            ...
            ProviderType.openAI, ProviderType.openAIResponses -> {
                ...
                val manualBearer = if (context != null &&
                    ...
                    com.miniseuleros.app.auth.OAuthManager.forInstance(context, instance)?.loadManualBearerToken()
                } else null
                ...
                if (instance.credentialType == ProviderCredential.oauth && manualBearer.isNullOrEmpty()
                    ...
                    OpenAIProvider(
                        oauthTokenProvider = { oauthManager.validAccessToken() ?: throw com.miniseuleros.app.data.model.LLMError.InvalidApiKey() },
                        model = model,
            ...
            ProviderType.xAI -> {
                ...
                if (instance.credentialType == ProviderCredential.oauth && manualBearer.isNullOrEmpty()
                    && context != null) {
                    val oauthManager = com.miniseuleros.app.auth.XAIOAuthManager(context, instance.id)
                    OpenAIProvider.oauthOpenAICompat(
                        oauthTokenProvider = {
                            oauthManager.validAccessToken()
                                ?: throw com.miniseuleros.app.data.model.LLMError.InvalidApiKey()
                        },
                        model = model,
                        basePath = base,
            ...
            ProviderType.kimiCode -> {
                ...
                val base = basePath ?: "${com.miniseuleros.app.auth.KimiDeviceFlow.CODING_API_BASE}/v1"
                val manualBearer = if (context != null &&
                    instance.credentialType == ProviderCredential.oauth) {
                    com.miniseuleros.app.auth.OAuthManager.forInstance(context, instance)?.loadManualBearerToken()
                } else null
                if (instance.credentialType == ProviderCredential.oauth && manualBearer.isNullOrEmpty()
                    && context != null) {
                    val oauthManager = com.miniseuleros.app.auth.KimiOAuthManager(context, instance.id)
