package com.miniseuleros.app.data.model
...
data class ProviderInstance(
     ...
     */
    @Serializable(with = com.miniseuleros.app.backup.Iso8601MillisSerializer::class)
...
data class ModelEntry(
    ...
    @Serializable(with = com.miniseuleros.app.backup.Iso8601MillisNullableSerializer::class)
