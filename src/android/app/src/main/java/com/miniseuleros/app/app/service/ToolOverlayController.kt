 ...
 *
 * Position persists in [com.miniseuleros.app.data.repository.BackgroundSettingsRepository]
...
class ToolOverlayController(private val context: Context) {
    ...
    // `miniseuleros://session/<id>` deep-link to land back in the right chat;
        ...
        try {
            ...
            val launchIntent = Intent(
                ...
                if (!sid.isNullOrBlank()) {
                    data = Uri.parse("miniseuleros://session/$sid")
                }
