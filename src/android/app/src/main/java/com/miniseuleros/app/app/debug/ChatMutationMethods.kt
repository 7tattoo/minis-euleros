...
import com.miniseuleros.app.ui.chat.InputAttachment
...
internal object ChatMutationMethods {
     ...
     * [com.miniseuleros.app.ui.chat.ChatViewModelStore]) — unlike [prompt], which
    ...
    suspend fun uiPrompt(context: Context, params: JSONObject): JSONObject {
        ...
        val app = app(context)
        val store = com.miniseuleros.app.ui.chat.ChatViewModelStore
        ...
        val vm = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.Main) {
            androidx.lifecycle.ViewModelProvider(
                ...
                com.miniseuleros.app.ui.chat.ChatViewModel.factory(
                    sessionId = sessionId,
            ...
            )[com.miniseuleros.app.ui.chat.ChatViewModel::class.java].also { it.sendMessage(text) }
        }
    ...
    suspend fun status(context: Context, params: JSONObject): JSONObject {
        ...
        return JSONObject().apply {
            ...
            put("isRunning", com.miniseuleros.app.service.SessionActivityTracker.isActive(sessionId))
