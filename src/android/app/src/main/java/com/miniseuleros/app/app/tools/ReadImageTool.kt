...
object ReadImageTool {
    ...
    fun definition(): AgentToolDefinition = AgentToolDefinition(
        ...
        parameters = mapOf(
            ...
            "path" to AgentToolParam("string", "Linux path (e.g. /var/minis-euleros/attachments/chart.png) or miniseuleros:// URL (e.g. miniseuleros://attachments/chart.png)"),
     ...
     * (`/var/minis-euleros/{attachments,workspace,offloads,browser}/...`) resolve
    ...
    fun execute(argsJson: String, sessionId: String? = null, context: Context? = null): ToolExecutionResult {
        return try {
            ...
            val path = if (rawPath.startsWith("miniseuleros://")) {
                "/var/minis-euleros/" + java.net.URLDecoder.decode(rawPath.removePrefix("miniseuleros://"), "UTF-8")
            } else rawPath
