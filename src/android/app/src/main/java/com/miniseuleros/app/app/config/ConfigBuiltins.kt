package com.miniseuleros.app.config

import android.content.Context
import com.miniseuleros.app.config.collections.EnvVarsCollection
import com.miniseuleros.app.service.DynamicIslandSupport
import com.miniseuleros.app.config.collections.GroupsCollection
import com.miniseuleros.app.config.collections.ModelsCollection
import com.miniseuleros.app.config.collections.ProvidersCollection
import com.miniseuleros.app.config.fields.ClosureField
import com.miniseuleros.app.config.fields.PrefsBoolField
import com.miniseuleros.app.config.fields.PrefsDoubleField
import com.miniseuleros.app.config.fields.PrefsEnumField
import com.miniseuleros.app.config.fields.PrefsIntCodedEnumField
import com.miniseuleros.app.config.fields.PrefsIntField
import com.miniseuleros.app.config.fields.PrefsLongField
import com.miniseuleros.app.config.fields.PrefsStringField
import com.miniseuleros.app.config.fields.ReadOnlyField
...
import com.miniseuleros.app.ui.chat.ChatViewModelStore
...
internal object ConfigBuiltins {
    ...
    private fun registerAppearance(r: ConfigRegistry, context: Context) {
        ...
        r.register(
            PrefsBoolField(
                ...
                prefs = prefs,
                key = com.miniseuleros.app.ui.settings.KEY_SHOW_CHAT_TITLE,
                defaultValue = true,
            )
        )
        r.register(
    ...
    private fun registerChat(r: ConfigRegistry, context: Context) {
        ...
        val appearancePrefs = context.getSharedPreferences(
            com.miniseuleros.app.ui.settings.PREF_APPEARANCE,
        ...
        r.register(
            PrefsIntCodedEnumField(
                ...
                key = com.miniseuleros.app.ui.settings.KEY_RETURN_KEY_BEHAVIOR,
        ...
        r.register(
            PrefsBoolField(
                ...
                prefs = appearancePrefs,
                key = com.miniseuleros.app.ui.settings.KEY_KEEP_SCREEN_AWAKE,
                defaultValue = false,
            )
        )
        ...
        r.register(
            PrefsBoolField(
                ...
                prefs = appearancePrefs,
                key = com.miniseuleros.app.ui.settings.KEY_TOOL_PREVIEW,
                defaultValue = true,
            )
        )
        ...
        r.register(
            PrefsBoolField(
                ...
                prefs = appearancePrefs,
                key = com.miniseuleros.app.ui.settings.KEY_AUTO_FOCUS_AFTER_REPLY,
                defaultValue = true,
            )
        )
        r.register(fontScaleField(
            ...
            prefs = appearancePrefs,
            key = com.miniseuleros.app.ui.settings.KEY_FONT_CHAT_INPUT,
        ))
        r.register(fontScaleField(
            ...
            prefs = appearancePrefs,
            key = com.miniseuleros.app.ui.settings.KEY_FONT_MESSAGE,
        ))
    }
    ...
    private fun registerLogs(r: ConfigRegistry, context: Context) {
        ...
        r.register(
            ClosureField(
                ...
                revertable = true,
                reader = {
                    ConfigValue.Bool(com.miniseuleros.app.logging.AppLogger.isEnabled(context))
                },
                writer = { v ->
                    val b = (v as? ConfigValue.Bool)?.value
                        ?: throw ConfigError.TypeMismatch("bool")
                    com.miniseuleros.app.logging.AppLogger.setEnabled(context, b)
                },
            )
        )
    }
    ...
    private fun registerProviderCollections(
        ...
        r.register(com.miniseuleros.app.config.collections.ThinkingRulesCollection(providerRepo))
        ...
        r.register(
            ReadOnlyField(
                ...
                reader = {
                    val cfg = providerRepo.config.value
                    val providersById = HashMap<String, com.miniseuleros.app.data.model.ProviderInstance>(cfg.instances.size)
        ...
        r.register(
            ClosureField(
                ...
                risk = ConfigRisk.SENSITIVE,
                revertable = true,
                reader = { ConfigValue.Bool(com.miniseuleros.app.data.EnvVarPrivacyStore.isEnabled) },
                writer = { v ->
                    val b = (v as? ConfigValue.Bool)?.value
                        ?: throw ConfigError.TypeMismatch("bool")
                    com.miniseuleros.app.data.EnvVarPrivacyStore.setEnabled(b)
                },
            )
        )
        ...
        r.register(
            ReadOnlyField(
                ...
                reader = {
                    val cfg = providerRepo.config.value
                    val entriesById =
                        HashMap<String, com.miniseuleros.app.data.model.ModelEntry>(cfg.modelEntries.size)
                    for (e in cfg.modelEntries) entriesById[e.id] = e
                    val providersById =
                        HashMap<String, com.miniseuleros.app.data.model.ProviderInstance>(cfg.instances.size)
                    for (inst in cfg.instances) providersById[inst.id] = inst
                    ConfigValue.Arr(
    ...
    private fun resolveSoulIconImage(context: Context, raw: String): String {
        val icon = com.miniseuleros.app.agent.SoulIcon
        val bytes: ByteArray = when (val src = icon.classifySource(raw)) {
            is com.miniseuleros.app.agent.SoulIcon.Source.Unsupported ->
                throw ConfigError.InvalidValue(src.reason)

            is com.miniseuleros.app.agent.SoulIcon.Source.Bytes -> src.data

            is com.miniseuleros.app.agent.SoulIcon.Source.LinuxPath -> {
                ...
                val kernel = com.miniseuleros.app.sandbox.PRootKernel
        ...
        return when (val r = icon.encode(bitmap)) {
            is com.miniseuleros.app.agent.SoulIcon.EncodeResult.Success -> r.dataUri
            is com.miniseuleros.app.agent.SoulIcon.EncodeResult.Failure -> when (r.reason) {
                com.miniseuleros.app.agent.SoulIcon.Rejection.TOO_LARGE ->
                    throw ConfigError.InvalidValue("that image is too large to store inline")
                com.miniseuleros.app.agent.SoulIcon.Rejection.UNREADABLE ->
    ...
    private fun registerSoul(r: ConfigRegistry, context: Context) {
        ...
        // English ≤ 500 words); see [com.miniseuleros.app.agent.SoulStore.isOverLimit].
        ...
        fun loadCurrent(): com.miniseuleros.app.agent.SoulFile =
            com.miniseuleros.app.agent.SoulStore.load(context)
                ?: com.miniseuleros.app.agent.SoulMDParser.parse(
                    com.miniseuleros.app.agent.SoulStore.DEFAULT_CONTENT
                )

        fun saveCurrent(file: com.miniseuleros.app.agent.SoulFile) {
            com.miniseuleros.app.agent.SoulStore.save(context, file)
        }
            ...
            ClosureField(
                ...
                writer = { v ->
                    ...
                    val name = raw.trim().ifBlank {
                        com.miniseuleros.app.agent.SoulMetadata.DEFAULT.name
                    }
                    val cur = loadCurrent()
        ...
        r.register(
            ClosureField(
                ...
                description = "The Soul's identity icon — also called its avatar, its persona image, or its " +
                    ...
                    "square, downscaled to ${com.miniseuleros.app.agent.SoulIcon.STORED_PIXELS}×" +
                    "${com.miniseuleros.app.agent.SoulIcon.STORED_PIXELS}, re-encoded as PNG and stored inline.\n" +
                    "\n" +
                ...
                reader = {
                    ...
                    ConfigValue.Str(
                        if (com.miniseuleros.app.agent.SoulIcon.isDataUri(raw)) "<image>" else raw,
                    )
                },
                writer = { v ->
                    val raw = (v as? ConfigValue.Str)?.value
                    ...
                    val next = when {
                        ...
                        com.miniseuleros.app.agent.SoulIcon.graphemeClusters(trimmed).size == 1 &&
                            com.miniseuleros.app.agent.SoulIcon.isEmojiGlyph(trimmed) -> trimmed
            ...
            ClosureField(
                ...
                reader = {
                    ...
                    ConfigValue.Str(cur.metadata.lang.ifBlank {
                        com.miniseuleros.app.agent.SoulMetadata.DEFAULT.lang
                    })
                },
                writer = { v ->
                    val raw = (v as? ConfigValue.Str)?.value
        ...
        r.register(
            ClosureField(
                ...
                description = "Personality / voice instructions injected as a block in the system prompt. Length cap is language-aware: Chinese ≤ ${com.miniseuleros.app.agent.SoulStore.CHINESE_CHAR_LIMIT} chars OR English ≤ ${com.miniseuleros.app.agent.SoulStore.ENGLISH_WORD_LIMIT} words (rule picked by the majority language). The writer also rejects prompt-injection patterns (\"ignore previous instructions\" etc.) — keep this to genuine character / tone guidance.",
                ...
                writer = { v ->
                    val raw = (v as? ConfigValue.Str)?.value
                        ?: throw ConfigError.TypeMismatch("string")
                    if (com.miniseuleros.app.agent.SystemPromptBuilder
                    ...
                    val check = com.miniseuleros.app.agent.SoulStore.isOverLimit(raw)
                    when (check) {
                        is com.miniseuleros.app.agent.SoulBodyLimitCheck.Ok -> Unit
                        is com.miniseuleros.app.agent.SoulBodyLimitCheck.OverLimitChinese ->
                            throw ConfigError.InvalidValue(
                                "Over limit: ${check.chars} Chinese chars exceeds cap of ${check.cap}. Either trim to ≤ ${check.cap} chars, or rewrite mostly in English to use the ≤ ${com.miniseuleros.app.agent.SoulStore.ENGLISH_WORD_LIMIT}-word cap."
                            )
                        is com.miniseuleros.app.agent.SoulBodyLimitCheck.OverLimitEnglish ->
                            throw ConfigError.InvalidValue(
                                "Over limit: ${check.words} English words exceeds cap of ${check.cap}. Either trim to ≤ ${check.cap} words, or rewrite mostly in Chinese to use the ≤ ${com.miniseuleros.app.agent.SoulStore.CHINESE_CHAR_LIMIT}-char cap."
                            )
                    }
                    val cur = loadCurrent()
