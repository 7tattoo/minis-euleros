...
import com.miniseuleros.app.data.model.normalizeModalityName
...
internal suspend fun performTest(
    ...
    if (kind == QuickTestKind.SPEECH_OUT || kind == QuickTestKind.TRANSCRIPTION) {
        val voice = com.miniseuleros.app.provider.voice.VoiceProviderFactory.make(instance, apiKey)
                ...
                if (!voice.supportsVoiceOutput) {
                    ...
                    runCatching {
                        ...
                        val data = voice.synthesize(
                            com.miniseuleros.app.provider.voice.VoiceOutputRequest(
                ...
                if (!voice.supportsVoiceInput) {
                    ...
                    runCatching {
                        val resp = voice.transcribe(
                            com.miniseuleros.app.provider.voice.VoiceInputRequest(
                                audioData = clip,
