package com.miniseuleros.app.ui.preview
...
import com.miniseuleros.app.MainActivity
import com.miniseuleros.app.R
import com.miniseuleros.app.logging.AppLogger

/**
 * Helper that pins a `file:///var/minis-euleros/...` HTML preview as a launcher
 * shortcut. Clicking the shortcut from the home screen sends a
 * `miniseuleros://preview/html?path=...&title=...` deep link back to
 * [MainActivity], which [com.miniseuleros.app.deeplink.DeepLinkHandler] parses
 * into [com.miniseuleros.app.deeplink.DeepLinkAction.OpenHtmlPreview]; the
...
object WebPreviewShortcut {
    ...
    fun pin(
        ...
        // file:///var/minis-euleros/browser/snake.html → /browser/snake.html
        val resourcePath = absPath.removePrefix("/var/minis-euleros").let {
        ...
        // miniseuleros://session/<sessionId>/<resource-path>?title=<title>
