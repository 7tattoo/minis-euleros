...
import com.miniseuleros.app.ui.components.SettingsRowDivider
import com.miniseuleros.app.ui.components.SettingsSection
        ...
        Column(
            ...
            SettingsSection(title = stringResource(R.string.rootfs_info_section)) {
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    Spacer(modifier = Modifier.height(8.dp))
                    Text(
                        text = "The rootfs contains the EulerOS Linux filesystem used by " +
