...
import com.miniseuleros.app.accessibility.AccessibilityRecoveryManager
...
import com.miniseuleros.app.deeplink.DeepLinkHandler
import com.miniseuleros.app.logging.AppLogger
import com.miniseuleros.app.service.SessionActivityTracker
import com.miniseuleros.app.ui.navigation.AppNavigation
import com.miniseuleros.app.ui.navigation.Routes
import com.miniseuleros.app.ui.navigation.safeNavigate
import com.miniseuleros.app.ui.NewerDatabaseGuidanceScreen
import com.miniseuleros.app.ui.settings.KEY_FONT_APP_BASE
import com.miniseuleros.app.ui.settings.KEY_KEEP_SCREEN_AWAKE
import com.miniseuleros.app.ui.settings.KEY_LANGUAGE
import com.miniseuleros.app.ui.settings.KEY_LAUNCH_SESSION
import com.miniseuleros.app.ui.settings.KEY_THEME_MODE
import com.miniseuleros.app.ui.settings.PREF_APPEARANCE
import com.miniseuleros.app.ui.settings.getAppearancePrefs
import com.miniseuleros.app.ui.settings.fontScaleForLevel
import com.miniseuleros.app.ui.settings.keepScreenAwakeEnabled
import com.miniseuleros.app.ui.theme.MinisTheme
...
class MainActivity : ComponentActivity() {
     ...
     * [com.miniseuleros.app.ui.navigation.AppNavigation]'s LaunchedEffect that
    ...
    override fun attachBaseContext(newBase: android.content.Context) {
        super.attachBaseContext(com.miniseuleros.app.i18n.LocaleWrap.wrap(newBase))
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (minisApp != null &&
            ...
            com.miniseuleros.app.data.db.DatabaseVersionGuard.Decision.SHOW_NEWER_DB_GUIDANCE
        ) {
        ...
        if (minisApp == null || !minisApp.subsystemsInitialized) {
            android.util.Log.w(
                ...
                "app subsystems not initialized (safeMode=" +
                    "${com.miniseuleros.app.crash.CrashFrequencyDetector.isSafeMode()}) — " +
                    "showing crash share dialog and finishing",
            )
            com.miniseuleros.app.crash.CrashFrequencyDetector.maybeShowOnActivity(
                activity = this,
        ...
        restoredChatSessionId = savedInstanceState?.getString(KEY_CURRENT_CHAT_SESSION_ID)
            ?.takeUnless {
                com.miniseuleros.app.crash.CrashFrequencyDetector.shouldForceHomeOnLaunch(this)
            }
        ...
        com.miniseuleros.app.share.ShareCoordinator.processPendingShare(this)
        ...
        if (BuildConfig.DEBUG) {
            com.miniseuleros.app.debug.DebugRPCHandler.currentActivity = java.lang.ref.WeakReference(this)
        }
        ...
        setContent {
            ...
            MinisTheme(darkTheme = darkTheme, fontScale = fontScale) {
                ...
                com.miniseuleros.app.ui.settings.ConfigConfirmDialogHost()
            }
        }
    }
     ...
     * is already covered by [com.miniseuleros.app.ui.navigation.AppNavigation]
