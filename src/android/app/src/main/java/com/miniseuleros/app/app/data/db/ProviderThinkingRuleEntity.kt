 ...
 * in [com.miniseuleros.app.provider.thinking.ThinkingRuleResolver.builtInRules] and are
...
data class ProviderThinkingRuleEntity(
    ...
    /** Serialized [com.miniseuleros.app.provider.thinking.ThinkingWireFormat]; null = "no opinion". */
