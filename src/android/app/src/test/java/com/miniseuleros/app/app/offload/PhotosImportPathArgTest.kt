package com.miniseuleros.app.offload

import com.miniseuleros.app.sandbox.offload.OffloadArgs
...
class PhotosImportPathArgTest {
    ...
    fun `positional path is accepted`() {
        assertEquals("/var/minis-euleros/offloads/p.jpg", resolvePath(listOf("import", "/var/minis-euleros/offloads/p.jpg")))
    }

    @Test
    fun `path flag still works`() {
        assertEquals("/var/minis-euleros/offloads/p.jpg", resolvePath(listOf("import", "--path", "/var/minis-euleros/offloads/p.jpg")))
    }
