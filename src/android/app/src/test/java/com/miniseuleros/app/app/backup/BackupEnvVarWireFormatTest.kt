...
class BackupEnvVarWireFormatTest {
    ...
    fun `provider instance createdAt is written as ISO and reads both forms`() {
        val millis = 1787270400000L
        val inst = com.miniseuleros.app.data.model.ProviderInstance(
            id = "i1",
            label = "L",
            providerType = com.miniseuleros.app.data.model.ProviderType.openAI,
            credentialType = com.miniseuleros.app.data.model.ProviderCredential.apiKey,
            createdAt = millis,
        )
        val json = BackupFormat.json.encodeToString(
            com.miniseuleros.app.data.model.ProviderInstance.serializer(), inst,
        )
        assertTrue(
        ...
        val back = BackupFormat.json.decodeFromString(
            com.miniseuleros.app.data.model.ProviderInstance.serializer(), json,
        )
        ...
        val old = BackupFormat.json.decodeFromString(
            com.miniseuleros.app.data.model.ProviderInstance.serializer(), legacy,
        )
